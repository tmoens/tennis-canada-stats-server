...
@Module({
  imports: [TypeOrmModule.forFeature([ItfMatchResult])],
  providers: [ItfMatchResultsService],
  controllers: [ItfMatchResultsController],
  exports: [TypeOrmModule, ItfMatchResultsService],
})
